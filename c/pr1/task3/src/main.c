...
int main(){
    ...
    uc=c=CHAR_MAX;
    printf("CHA_MAX : c=%d uc=%d\n", c, uc);
    c++; uc++;
    printf("CHAR_MAX+1 : c=%d uc=%d\n", c, uc);
    
    //минимально возможное значение символа
    uc=c=CHAR_MIN;
    printf("CHAR_MI : c=%d uc=%d\n", c, uc);
    
    //максимально возможное значение беззнакового символа
    c=uc=UCHAR_MAX;
    ...
    //максимально возможное значение 2 байтового целого числа
    c = (char)SHRT_MAX; //отбросится до -1
    s = SHRT_MAX;
    uc=s;
    printf("SHRT_MAX : c=%d uc=%d s=%d\n", c, uc, s);
    s++;
    printf("SHRT_MAX+1 : s=%d\n", s); c=s; uc=s; 
    //минимально возможное значение 2 байтового целого числа
    printf("%d : c=%d uc=%d\n", SHRT_MIN, c, uc);
    s=0; c=s; uc=s; 
    printf("0 : c=%d uc=%d s=%d\n", c, uc, s);
    //максимально возможное значение 4 байтового целого числа
    i=INT_MAX; l=i; u=i;
    printf("INT_MAX : i=%d u=%u l=%ld\n", i, u, l);
    i++; l++; u++;
    printf("INT_MAX+1 : i=%d u=%u l=%ld\n", i, u, l);
    //минимально возможное значение 4 байтового целого числа
    i=INT_MIN; l=i; u=i;
    printf("INT_MIN : i=%d u=%u l=%ld\n", i, u, l);
    //максимально возможное значение 4 байтового целого беззнакового числа
    u=UINT_MAX; i=u; l=u;
    ...
    i=5.9;
    printf("i=5.9 : i=%d\n", i);
    //максимально возможное значение 4 байтового дробного числа
    d=f=FLT_MAX;
    printf("FLT_MAX : f=%g d=%g\n", f, d);
    //минимально возможное значение 4 байтового дробного числа
    d=f=FLT_MIN;
    ...
    //максимально возможное значение 8 байтового дробного числа
    d=DBL_MAX;
    printf("DBL_MAX : d=%g\n", d);
    //минимально возможное значение 8 байтового дробного числа
    d=DBL_MIN;
    printf("DBL_MIN : d=%g\n", d);
    //2.22045e-16
    d=DBL_EPSILON;
    ...
    printf("1e15+1 : d=%lf\n", d); d=1e16+1;
    printf("1e16+1 : d=%lf\n", d);
    f=10000*100000; f+=1; f-=4*250000000;
    printf("1 : f=%f\n", f);
